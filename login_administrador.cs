...
namespace VRS
{
    public partial class login_administrador : Form
    {

        string nombre, perfil;
        public login_administrador(string n, string m)
        {
            nombre = n;
            perfil = m;
        ...
        {
            Form Formulario = new PanelCentral(nombre, perfil);
            Formulario.Show();
            Visible = false;
            this.Hide();
        }
        ...
        private void login_administrador_Load(object sender, EventArgs e)
        {
